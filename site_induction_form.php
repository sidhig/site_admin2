...
else
{
 ...
 // if(isset($_POST['logout_induction']))
 // {
 // 	header("location:header.php");
 // 	unset($_SESSION['login_user_induction']);
 // }
...
if($qry_declaration && $qry_topic && $qry_attachment && $qry_employee && $qry_induction_register)
{
	...
	?>
		 <script>
		              ...
		              window.location.href='site_induction_form.php';
		  </script>
 		<?
					...
					<div class="col-sm-12">
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								...
								<input type="text" name="induction_number" class="form-control" value="<? $value= str_pad($obj2->id, 4, '0', STR_PAD_LEFT); echo $value;  ?>" readonly>
 ...
 -->
						...
						<div class="row" style="border-bottom: 1px solid black">
							...
							<div class="col-sm-3 form-group">
								...
								<input type="text" name="sign_div_hidden" id="sign_div_hidden" hidden>
