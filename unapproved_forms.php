...
WHERE (inducted_by IS NULL OR inducted_by='') AND tbl_induction_register.project_id= '".$_SESSION['admin']."' order by tbl_induction_register.id desc");
?>
...
<body onbeforeunload=”HandleBackFunctionality()” style="background-color: white">
    ...
    width: 65%">
    		...
    		<div class="Form_name" style="text-shadow:1px 1px 1px rgba(18,18,18,1);font-weight:normal;color:#6495ED	 ;letter-spacing:1pt;word-spacing:0pt;font-size:23px;text-align:center;font-family:verdana, sans-serif;line-height:2; background-color: #696969">UNAPPROVED SITE INDUCTION FORMS 
			</div>
