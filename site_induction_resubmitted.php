...
<div class="Main_Form" style="border: 1px solid grey;
 ...
 <table style='width: 70%;border: 1px solid rgba(128, 128, 128, 0.57);'>
          <center><div class="Form_name"> <span style="text-shadow:1px 1px 1px rgba(18,18,18,1);font-weight:normal;color:#FF5733 ;letter-spacing:1pt;word-spacing:0pt;font-size:23px;text-align:center;font-family:verdana, sans-serif;line-height:2;"> RESUBMITTED SITE INDUCTION FORM </span>
			</div>
			</center>
					...
					<div class="col-sm-12">
						...
						<div class="row">
							...
							<div class="col-sm-6 form-group">
								...
								<input type="submit" class="btn btn-primary" id= "submit" value="Approve"  name="set" style="width:20vw; height:4rem; color:black;margin-top:3rem; font-size: 15px; font-weight: bold"    />
							...
							<div class="col-sm-6 form-group">
								...
								<input type="submit" class="btn btn-primary" id= "submit" value="Back To Approved Forms"  name="back" style="width:20vw; height:4rem; color:black;margin-top:3rem; font-size: 15px; font-weight: bold"    />
