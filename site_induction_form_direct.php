...
$obj3=$conn->query("select tbl_access.id,name from tbl_project_register left join tbl_access on tbl_project_register.access_id = tbl_access.id where tbl_project_register.project_id = '".$_SESSION['admin2']."' group by access_id");
								...
								<select style="height: 34px;display: block;width: 100%;padding: 6px 12px;font-size: 14px;line-height: 1.42857143;color: #555;background-color: #fff;background-image: none;border: 1px solid #ccc;border-radius: 4px;" id="access" onchange="select1()" required>
								 ...
								 function select1() {
								   ...
								   var strUser = e.options[e.selectedIndex].value;
									...
									$.ajax({
									    type: "POST",
									    url: "ajax_access_authority_direct.php",
									    data: {text1: strUser},
