...
if(isset($_POST['edit']) & $_POST['edit']=='true')
    ...
    if($_POST['edit_id']!='')
    {
      ...
      $err1 = $_POST['company']." updated successfully.";
...
<strong style='font-size:2.0rem'>Edit Employee</strong><br><br>
    ...
    padding: 16px;' >
         ...
         <tr align="left"><th>Address :<span style="color:red;">*</span></th>
          ...
          <select name="empe_trade">
        <?php foreach ($trade as $id=> $value) { ?>
          <option value="<?php echo $value;?>" <?php echo ($obj->Tread ==  $value) ? ' selected="selected"' : '';?>><?php echo $value;?></option>
        <?php } ?>
        </select>
